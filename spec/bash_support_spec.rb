COLOR_RED = ENV['COLOR_RED']
COLOR_GREEN = ENV['COLOR_GREEN']
COLOR_YELLOW = ENV['COLOR_YELLOW']
COLOR_BLUE = ENV['COLOR_BLUE']
COLOR_AQUA = ENV['COLOR_AQUA']
COLOR_GREY = ENV['COLOR_GREY']
COLOR_PINK = ENV['COLOR_PINK']
COLOR_RESET = ENV['COLOR_RESET']
COLOR_LIGHT_PINK = ENV['COLOR_LIGHT_PINK']
  ...
  describe 'echoerr' do
    it 'returns red text for echoerr' do
      expect(run 'echoerr No', expect_exit: 1).to have_output(
        stderr: "#{COLOR_RED}No#{COLOR_RESET}\n",
        stdout: nil
      )
    end
  end
